(function() {
	...
	if(currentScopeId!=formScope){
		gs.addErrorMessage('The form does not belong to the current application scope.Please choose the correct application scope \"'+current.getDisplayValue('u_scope')+'\" before deploying');
		action.setRedirectURL(current);
		return;
	}
	
	//Generate the updatesetName : 
	...
	var catalogUrl ='com.glideapp.servicecatalog_cat_item_view.do?v=1&sysparm_id=52f193a3db68205c4f73498039961949&sysparm_formid='+current.getValue('sys_id')+'&sysparm_updatesetName='+encodeURI(updateSetName);
